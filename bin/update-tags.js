...
cljs.core._with_meta["function"] = function(a, b) {
  return cljs.core.with_meta.call(null, function() {
    if(void 0 === cljs.core.t2832) {
      cljs.core.t2832 = {};
      cljs.core.t2832 = function(a, b, c) {
        this.meta = a;
        this.f = b;
        this.meta2833 = c;
      ...
      cljs.core.t2832.cljs$lang$type = !0;
      cljs.core.t2832.cljs$lang$ctorPrSeq = function() {
        return cljs.core.list.call(null, "cljs.core/t2832")
      };
      cljs.core.t2832.cljs$lang$ctorPrWriter = function(a, b) {
        return cljs.core._write.call(null, b, "cljs.core/t2832")
      };
      var c = cljs.core.t2832.prototype, d = function(a, b) {
      ...
      c.call = e;
      cljs.core.t2832.prototype.apply = function(a, b) {
        a = this;
        return a.call.apply(a, [a].concat(b.slice()))
      };
      cljs.core.t2832.prototype.cljs$core$Fn$ = !0;
      cljs.core.t2832.prototype.cljs$core$IMeta$_meta$arity$1 = function() {
        return this.meta2833
      };
      cljs.core.t2832.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = function(a, b) {
        return new cljs.core.t2832(this.meta, this.f, b)
      }
    }
    return new cljs.core.t2832(b, a, null)
  }(), b)
};
...
var update_tags = {core:{}};
update_tags.core.fs = cljs.nodejs.require.call(null, "fs");
update_tags.core.exec = cljs.nodejs.require.call(null, "child_process").exec;
update_tags.core.ctags_opts = cljs.nodejs.process.env.CTAGS;
update_tags.core.tag_file_lines = function() {
  return clojure.string.split_lines.call(null, update_tags.core.fs.readFileSync(update_tags.core._STAR_tag_file_STAR_))
};
update_tags.core.matches_src_file = function(a) {
  return cljs.core.re_find.call(null, cljs.core.re_pattern.call(null, update_tags.core._STAR_src_file_STAR_), a)
};
update_tags.core.remove_old_lines = function(a) {
  return cljs.core.filter.call(null, cljs.core.comp.call(null, cljs.core.not, update_tags.core.matches_src_file), a)
};
update_tags.core.write_to_tag_file = function(a) {
  return update_tags.core.fs.writeFileSync(update_tags.core._STAR_tag_file_STAR_, clojure.string.join.call(null, "\n", a))
};
update_tags.core.remove_old_tags = function() {
  return update_tags.core.write_to_tag_file.call(null, update_tags.core.remove_old_lines.call(null, update_tags.core.tag_file_lines.call(null)))
};
update_tags.core.update_tag_file = function() {
  var a = [cljs.core.str("ctags -a -f "), cljs.core.str(update_tags.core._STAR_tag_file_STAR_), cljs.core.str(" "), cljs.core.str(update_tags.core.ctags_opts), cljs.core.str(" "), cljs.core.str(update_tags.core._STAR_src_file_STAR_)].join("");
  return update_tags.core.exec.call(null, a)
};
update_tags.core.start = function() {
  var a = function(a, b) {
    var e = update_tags.core._STAR_tag_file_STAR_, f = update_tags.core._STAR_src_file_STAR_;
    try {
      return update_tags.core._STAR_tag_file_STAR_ = a, update_tags.core._STAR_src_file_STAR_ = b, update_tags.core.remove_old_tags.call(null), update_tags.core.update_tag_file.call(null)
    }finally {
      update_tags.core._STAR_src_file_STAR_ = f, update_tags.core._STAR_tag_file_STAR_ = e
    }
  }, b = function(b, d, e) {
    var f = null;
    goog.isDef(e) && (f = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2), 0));
...
cljs.core._STAR_main_cli_fn_STAR_ = update_tags.core.start;
cljs.nodejscli = {};
